...
public:
    static const int kOpenTime = 10;         // seconds
    static const int kConnectInterval = 5;  // seconds
    static const int kHoldTime = 35;         // seconds
    static const int kMaxAttempts = 2;
    static const int kJitter = 2;           // percentage
